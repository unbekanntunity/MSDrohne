...
#define DATE "built on: Sun Feb 20 13:46:04 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','k','a','l','i',
    '/','M','S','D','r','o','h','n','e','/','.','b','u','i','l','d',
    'o','z','e','r','/','a','n','d','r','o','i','d','/','p','l','a',
    't','f','o','r','m','/','b','u','i','l','d','-','a','r','m','e',
    'a','b','i','-','v','7','a','/','b','u','i','l','d','/','p','y',
    't','h','o','n','-','i','n','s','t','a','l','l','s','/','m','s',
    'd','r','o','h','n','e','/','i','n','c','l','u','d','e','/','p',
    'y','t','h','o','n','3','.','8','\0'
};
